...
/** Android actual placeholder until the JNI map projection bridge is migrated. */
...
private fun unsupportedMapProjectionHandle(): Nothing =
  throw UnsupportedOperationException(
    "MapProjectionHandle is not available until the Android map bridge is implemented"
  )
