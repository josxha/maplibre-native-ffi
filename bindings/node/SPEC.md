...
src/map.rs        map handle, map/viewport/tile/projection/bounds option materialization, style-loading/probes, URL/tile source helpers, image source values, style ID lists, style metadata/layer/light JSON/properties, camera commands, repaint, debug-option, and utility proof slices
