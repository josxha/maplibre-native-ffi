...
src/map.rs        map handle, map option materialization, style-loading, repaint, debug-option, and utility proof slices
...
5. Add `MapHandle`, map options, style loading, map-owned callbacks, and parent
   ...
   debug-option string mapping, and parent-retention proof slice complete.)_
